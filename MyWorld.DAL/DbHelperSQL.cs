...
namespace MyWorld.DAL
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static string conn_MyWorld = ConfigurationManager.ConnectionStrings["conn_MyWorld"].ConnectionString;
        ...
        public static bool ColumnExists(string connectiongString, string tableName, string columnName)
        {
        ...
        {
            using (SqlConnection connection = new SqlConnection(conn_MyWorld))
            {
        ...
        {
            using (SqlConnection conn = new SqlConnection(conn_MyWorld))
            {
                conn.Open();
        ...
        {
            SqlConnection connection = new SqlConnection(conn_MyWorld);
